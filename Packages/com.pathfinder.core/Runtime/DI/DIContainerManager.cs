...
namespace Pathfinder.Core.DI
{
    public static class DIContainerManager
    {
        ...
        {
            var rootContexts = UnityEngine.Object.FindObjectsByType<RootContext>(FindObjectsSortMode.None);
        ...
        {
            var installers = UnityEngine.Object.FindObjectsByType<Installer>(FindObjectsSortMode.None);
